...
export const PRESS_ARTICLES: PressArticle[] = [
  {
    ...
    excerpt:
      "Union Minister Pralhad Joshi inaugurated the K2 Group's integrated bio-energy cluster in Rewari — four complementary facilities converting agricultural waste into fuel, electricity, and cattle feed, with assured buy-back prices for farmers.",
  ...
  },
  {
    ...
    outlet: "Zee Business",
    headline:
      "Rewari Biomass Pellet Facility to Boost Clean Fuel and Rural Economy: Pralhad Joshi",
    excerpt:
      "Union Minister Pralhad Joshi inaugurated K2 Biofuels' pellet plant in Rewari, Haryana, calling it a milestone for India's clean energy transition and a model for converting agricultural residue into rural economic opportunity.",
  ...
  },
  {
    ...
    headline:
      "K2 Biofuels completes 252 TPD pellet plant commissioning in Rewari, targets NCR thermal supply chain",
    excerpt:
      "The Haryana-based biomass manufacturer has commissioned its full-capacity plant ahead of the upcoming stubble season, positioning itself as a primary supplier to Delhi-NCR thermal plants under the CAQM co-firing directive.",
  ...
  },
  {
    ...
    headline:
      "CAQM tightens co-firing norms: NCR thermal plants to increase biomass blend to 10% by FY2027",
    excerpt:
      "The Commission for Air Quality Management has issued an updated direction requiring coal-based thermal power plants in the National Capital Region to progressively increase biomass co-firing to 10% by the end of FY2027.",
  ...
  },
  {
    ...
    outlet: "PIB",
    headline:
      "PM Paddy Straw Mission: Government establishes 200 new pelletisation clusters across Punjab, Haryana and UP",
    excerpt:
      "Under the Prime Minister's paddy straw utilisation initiative, the Ministry of New and Renewable Energy has identified 200 new pelletisation cluster locations to be commissioned by March 2027.",
  ...
  },
  {
    ...
    outlet: "ANI",
    headline:
      "Biomass pellet capacity in north India doubles as thermal sector demand accelerates",
    excerpt:
      "Industry data shows a doubling of operational biomass pellet manufacturing capacity in Haryana and Punjab over the last 18 months, driven by mandatory co-firing requirements and a surge in private industrial boiler conversions.",
  ...
  },
  {
    ...
    headline:
      "Haryana biomass producers see record orders as CAQM mandate takes hold ahead of kharif season",
    excerpt:
      "Biomass fuel producers in Haryana are reporting three to four times the order volume compared to the same period last year, as thermal plants accelerate procurement ahead of the October enforcement deadline.",
  ...
  },
  {
    ...
    headline:
      "From stubble smoke to industrial fuel: K2 Biofuels' Rewari model gains policy and market traction",
    excerpt:
      "A ground report from K2 Biofuels' 252 TPD plant in Rewari examines how the company is building a feedstock supply chain across 8,400 acres of farmland while supplying pellets and briquettes to thermal plants, sugar mills and brick kilns.",
...
export const NEWS_VIDEOS: NewsVideo[] = [
  {
    ...
    source: "ANI",
    title:
      "CAQM mandates paddy-straw biomass co-firing at NCR thermal plants — compliance timeline",
    description:
      "ANI reports on the Commission for Air Quality Management's updated direction on biomass co-firing, speaking to plant operators and biomass suppliers about implementation timelines and feedstock availability.",
  ...
  },
  {
    ...
    source: "ANI",
    title:
      "Environment Ministry: paddy straw mission to reduce crop residue burning by 40% in three years",
    description:
      "Union Environment Minister briefs press on the government's paddy straw utilisation targets, citing pelletisation capacity expansion and mandatory co-firing as the twin pillars of the strategy.",
  ...
  },
  {
    ...
    source: "DD News",
    title:
      "From fields to furnaces: Haryana's biomass fuel story — DD News ground report",
    description:
      "DD News visits biomass pellet manufacturing facilities in Rewari district and speaks to farmers, aggregators and plant operators about the economics of stubble collection and the emerging industrial fuel supply chain.",
  ...
  },
  {
    ...
    source: "YouTube",
    title:
      "Inside K2 Biofuels | 252 TPD Biomass Pellet Plant Tour | Rewari, Haryana",
    description:
      "A walkthrough of K2 Biofuels' manufacturing facility in Rewari — covering the feedstock intake weighbridge, rotary drum dryers, pellet mills, quality laboratory, and 5,500 MT covered storage.",
