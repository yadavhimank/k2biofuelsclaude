...
export default function AboutPage() {
  return (
    <>
      ...
      <section data-screen-label="About · Hero" style={{ position: 'relative', height: '100vh', minHeight: 600, marginTop: '-120px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', overflow: 'hidden' }}>
        ...
        <div className="k2-about-facts" style={{ maxWidth: 1320, margin: '0 auto', gap: 0 }}>
          {[
            ...
            <div key={k} style={{
              ...
              <div style={{ fontFamily: 'var(--k2-mono)', fontSize: 22, color: 'var(--k2-ink)', letterSpacing: -0.5 }}>{v}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section style={{ padding: '112px 32px' }}>
        <div className="k2-grid-stack-mobile" style={{ maxWidth: 1320, margin: '0 auto', gridTemplateColumns: '1fr 1.5fr', gap: 96 }}>
          ...
          <div style={{ fontSize: 16, lineHeight: 1.75, color: 'var(--k2-text-2)' }}>
            <p style={{ margin: '0 0 22px' }}>
              <strong style={{ color: 'var(--k2-ink)' }}>K2 BioFuels Pvt. Ltd.</strong> is a forward-looking renewable energy company focused on the development and production of biofuels derived from biomass and organic resources. As a responsible energy enterprise, we deliver sustainable fuel solutions that meet growing industrial energy demands while contributing to environmental conservation.
            </p>
            <p style={{ margin: '0 0 22px' }}>
              Our mission is to reduce dependence on fossil fuels by promoting clean, renewable, and eco-friendly energy alternatives. By utilizing biomass and organic resources, we transform agricultural and organic waste into valuable energy products — supporting both circular-economy principles and rural economic development.
            </p>
            <p style={{ margin: '0 0 22px' }}>
              At K2 BioFuels, sustainability sits at the core of every decision. We integrate modern technology, efficient production processes, and strict quality standards to deliver consistent, high-performance biofuel products. Our solutions are designed to help industries transition toward greener energy sources without compromising on efficiency or reliability.
            </p>
            <p style={{ margin: '0 0 22px' }}>
              We believe renewable energy is not an alternative — it is the future. Through innovation, responsible practices, and long-term vision, K2 BioFuels Pvt Ltd. aims to play a meaningful role in India&apos;s clean energy transformation.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '80px 32px', background: 'var(--k2-stone)' }}>
        <div className="k2-grid-2" style={{ maxWidth: 1320, margin: '0 auto', gap: 64 }}>
          <div>
            ...
            <p style={{ fontSize: 16, lineHeight: 1.7, color: 'var(--k2-text-2)', margin: 0 }}>
              Replace one tonne of imported coal at a time, with one tonne of biomass that would otherwise have been burnt in the open. Profitably, repeatably, and at industrial scale.
            </p>
          </div>
          <div>
            <Eyebrow style={{ marginBottom: 14 }}>— 03 / Vision</Eyebrow>
            <h3 style={{ fontSize: 26, margin: '0 0 16px', fontWeight: 500, letterSpacing: '-0.015em' }}>Where we are heading</h3>
            <p style={{ fontSize: 16, lineHeight: 1.7, color: 'var(--k2-text-2)', margin: 0 }}>
              A globally trusted biofuels manufacturer supporting the transition to renewable energy across industries — built on real plants, real lab data, and a workforce that lives within commute of where the work happens.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="k2-section-header" style={{ marginBottom: 56 }}>
            <div>
              ...
              <h2 style={{ fontSize: 44, margin: 0, lineHeight: 1.1, letterSpacing: '-0.025em', fontWeight: 500 }}>
                Built and run by promoters,<br />
                <Em>not by a fund.</Em>
              </h2>
            </div>
            <div style={{ fontSize: 14, color: 'var(--k2-text-2)', maxWidth: 320, textAlign: 'right', lineHeight: 1.6 }}>
              Operational leadership with three decades across renewable energy, grain processing, and rural enterprise.
            </div>
          </div>
            ...
            {[
              ...
              <div key={l.name} className="k2-leader-card" style={{
                ...
                <div>
                  ...
                  <p style={{ fontSize: 14, lineHeight: 1.65, color: 'var(--k2-text-2)', margin: 0 }}>{l.bio}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="k2-grid-stack-mobile" style={{ maxWidth: 1320, margin: '0 auto', gridTemplateColumns: '1fr 1.6fr', gap: 80, alignItems: 'start' }}>
          <div>
            ...
            <h2 style={{ fontSize: 40, margin: 0, lineHeight: 1.1, letterSpacing: '-0.025em', fontWeight: 500 }}>
              On the future of energy,<br />
              <Em color="#FFB37A">from the boardroom.</Em>
            </h2>
          </div>
          <div style={{ fontSize: 17, lineHeight: 1.7, color: 'rgba(250,250,247,0.85)' }}>
            <p style={{ margin: '0 0 22px' }}>
              At <strong style={{ color: '#fff' }}>K2 Biofuels Pvt. Ltd.</strong>, we believe the future of energy lies in sustainability, innovation, and responsibility. Our vision is to reduce dependence on fossil fuels by delivering clean and reliable biofuel solutions derived from biomass and organic resources.
            </p>
            <p style={{ margin: '0 0 22px' }}>
              As we move forward, our focus remains on integrating advanced technologies with operational excellence and affordability. We are committed to supporting industrial energy needs while contributing to environmental protection and rural economic development.
            </p>
            <p style={{ margin: '0 0 36px' }}>
              We thank our partners, customers, and stakeholders for their continued trust and support as we work together toward a greener and more sustainable future.
            </p>
      ...
      <section style={{ padding: '112px 32px' }}>
        <div style={{ maxWidth: 1320, margin: '0 auto' }}>
          <div style={{ marginBottom: 48 }}>
            <Eyebrow style={{ marginBottom: 14 }}>— 06 / K2 Group of Industries</Eyebrow>
            <h2 style={{ fontSize: 44, margin: 0, lineHeight: 1.1, letterSpacing: '-0.025em', fontWeight: 500, maxWidth: 800 }}>
          ...
          <div className="k2-grid-3" style={{ gap: 24 }}>
            {[
              ...
              { name: 'K2 Ethanol', status: 'Commissioning', desc: 'Grain-based ethanol distillery with cattle feed unit and rice mill, supplying OMCs under the EBP.', cap: 'Capacity · 150 KLPD', live: 'Commissioning', bar: 'var(--k2-ink)', highlight: false },
            ].map((c) => (
              <div key={c.name} style={{
                background: c.highlight ? 'var(--k2-canvas)' : 'var(--k2-surface)',
                border: c.highlight ? '2px solid var(--k2-ink)' : '1px solid var(--k2-border-med)',
                padding: 32,
              }}>
                <div style={{ width: 40, height: 6, background: c.bar, marginBottom: 24 }} />
      ...
      {/* Why K2 — quick grid */}
      <section style={{ padding: '64px 32px 96px', background: 'var(--k2-stone)' }}>
        <div style={{ maxWidth: 1320, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            <Eyebrow style={{ marginBottom: 14 }}>— 07 / Why K2 Biofuels</Eyebrow>
            <h2 style={{ fontSize: 34, margin: 0, lineHeight: 1.15, letterSpacing: '-0.025em', fontWeight: 500 }}>
              What sets us apart.
            </h2>
          </div>
          <div className="k2-grid-4" style={{ gap: 16 }}>
            {[
              ...
              ['Industrial scale', '252 TPD installed capacity. Volume-protected contracts.'],
              ['Innovation driven', 'Advanced processing, automated bagging, real-time QC.'],
            ].map(([h, b], idx) => (
